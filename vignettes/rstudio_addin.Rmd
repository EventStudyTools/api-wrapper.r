...
You can work then in the addin as on our web API interface that is self-explanatory. Beside our web API interface it is mandatory to use a EventStudyTools key that can be copied from our [web page](https://www.eventstudytools.com/) for **free**. 
