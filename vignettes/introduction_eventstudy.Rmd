...
You get a **free** API key from our website [TODO: Link to Site](http://eventstudytools.com). In the first step we need to authenticate to the web API. There are two ways to handle this two parameters:
...
4. RStudio Addins: We wrote several RStudio addins for performing an Event Study
    - Abnormal Return Event Study Addin
    - Abnormal Volume Event Study Addin (Comming soon)
    - Abnormal Volatility Event Study Addin (Coming soon)
