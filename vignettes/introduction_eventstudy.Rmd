...
You get a **free** API key from our website [http://eventstudytools.com/api-key](http://eventstudytools.com/api-key). In the first step we need to authenticate to the web API. There are two ways to handle this two parameters:
