...
We use the package (tidyquant)[https://cran.r-project.org/web/packages/tidyquant/index.html] to fetch the automotive stock data from (Yahoo Finance)[https://de.finance.yahoo.com/]. As we cannot get the full volume size from this companies through Yahoo Finance API, we do not perform a volume Event Study in this vignette.
